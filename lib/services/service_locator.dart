...
import 'package:irondex/services/supabase/supabase_free_weight_repository.dart';
...
class ServiceLocator {
  ServiceLocator._({
    ...
    required this.freeWeightRepository,
  ...
  final FreeWeightRepository freeWeightRepository;
  ...
  factory ServiceLocator.initialize({SupabaseClient? client}) {
    _instance = ServiceLocator._(
      ...
      freeWeightRepository: SupabaseFreeWeightRepository(client: client),
