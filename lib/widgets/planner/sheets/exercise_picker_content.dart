...
typedef ExercisePickerListBuilder =
    Widget Function(
...
class ExercisePickerContent extends StatefulWidget {
  const ExercisePickerContent({
    super.key,
    required this.listBuilder,
    this.title = 'Select Exercise',
    this.searchHint = 'Search exercise name',
    this.onClose,
    this.additionalSections = const <Widget>[],
    this.initialSearchQuery,
  });

  final ExercisePickerListBuilder listBuilder;
  final String title;
  ...
  @override
  State<ExercisePickerContent> createState() => _ExercisePickerContentState();
}

class _ExercisePickerContentState extends State<ExercisePickerContent> {
