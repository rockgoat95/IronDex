...
class SupabaseManager:
    ...
    def upload_from_url(self, *, bucket_name: str, url: str):
        ...
        For freemotionfitness.com URLs, uses local fallback files from data/freemotion/ directory.
        """
        try:
    ...
    def _upload_freemotion_from_local(self, bucket_name: str, url: str):
        ...
        freemotion_dir = os.path.join(os.path.dirname(__file__), "../../data/freemotion")
        ...
        try:
            ...
            print(f"Successfully uploaded freemotion file {filename} to {destination_path}")
